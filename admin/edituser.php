...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE data_user
              SET nama_user='$nama_user', email='$email', passw='$passw'
              WHERE id=$id";
...
<body class="bg-light" data-aos="fade-in">
    ...
    <div class="d-flex">
        ...
        <div class="container p-5 rounded mb-5 mt-4" style="width: 75%; height: max-content; margin: 0 auto; display: block;">
            <h3 class="fw-bold text-center">Edit Data User</h3>
            <form method="POST">
                ...
                <div class="mb-3 position-relative">
                    ...
                    <input type="password" id="password" name="passw" class="form-control" value="<?= $data['passw'] ?>" required>
                ...
                <a href="datauser.php" class="btn dynamic-btn">Batal</a>
