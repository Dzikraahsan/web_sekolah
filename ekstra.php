                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-3 c-a">
                        <div class="card card1 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217655/pmi_jqnrpb.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                        <div class="card card2 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217658/pecinta_alam_rbnr1b.png" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                        <div class="card card3 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217656/voli_nofq1v.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                         <div class="card card4 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217655/jurnalis_r6z53k.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                        <div class="card card1 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217655/japan_club_phgsg9.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                        <div class="card card2 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217655/english_club_coyzvr.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                        <div class="card card3 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217654/basket_dm4sa4.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
                    ...
                    <div class="col-md-3 c-a">
                         <div class="card card4 mt-5">
                            <img src="https://res.cloudinary.com/da4fjxm1e/image/upload/v1757217654/badminton_j6akjd.jpg" class="card-img-top mt-4 mb-3" style="width: 80%; height: 80%; display: block; margin: 0 auto;" alt="">
                            <div class="card-body text-center">
